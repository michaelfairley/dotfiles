...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (direnv rg lua-mode magit rspec-mode toml-mode avy haml-mode markdown-mode racer haxe-mode glsl-mode flycheck-rust exec-path-from-shell deferred company comment-dwim-2 cargo))))
(custom-set-faces
